...
const routes: RouteRecordRaw[] = [
	{
		...
		children: [
			// 题目分类静态路由，放到主布局 children 下
			{
				path: 'question/category/hot',
				name: '热门题目',
				component: () => import('/$/question/views/category/hot.vue')
			},
			{
				path: 'question/category/algo',
				name: '算法',
				component: () => import('/$/question/views/category/algo.vue')
			},
			{
				path: 'question/category/db',
				name: '数据库',
				component: () => import('/$/question/views/category/db.vue')
			},
			{
				path: 'question/category/data-structure',
				name: '数据结构',
				component: () => import('/$/question/views/category/data-structure.vue')
			},
			{
				path: 'question/category/system-design',
				name: '系统设计',
				component: () => import('/$/question/views/category/system-design.vue')
			},
			{
				path: 'question/category/:categoryName',
				name: '题库分类详情',
				component: () => import('/$/question/views/categorydetail.vue'),
				props: true
			}
		]
	},
